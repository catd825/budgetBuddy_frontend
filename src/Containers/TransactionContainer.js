            ...
            <>
                ...
                <>
                    ...
                    <Route exact path="/transactions/:id/edit" render={({match})=> {
                        ...
                        <Route exact path="/transactions" render={() => <TransactionList currentMonth={this.props.currentMonth} submitHandler={this.props.submitHandler} currentUser={this.props.currentUser} deleteHandler={this.props.deleteHandler} editHandler={this.props.editHandler} categories={this.props.categories} transactions={this.props.transactions}/>} />
                    </Switch>
                    </>
                }
            </>        
